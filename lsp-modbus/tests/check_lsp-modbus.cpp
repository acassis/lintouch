// $Id: check_lsp-rllib.cpp 575 2005-04-22 10:38:19Z mman $
//
//   FILE: check_lsp-rllib.cpp --
    ...
    public:
        ...
        void testPluginLoad() {
            ...
            pluginfile = apr_pstrcat( pool,
                    builddir, "/.libs/ModbusTCPSlave-0.dll", NULL );
            pluginfile = apr_pstrcat( pool,
                    builddir, "/.libs/ModbusTCPMaster-0.dll", NULL );
#else
            pluginfile = apr_pstrcat( pool,
                    builddir, "/.libs/ModbusTCPSlave.so", NULL );
            pluginfile = apr_pstrcat( pool,
                    builddir, "/.libs/ModbusTCPMaster.so", NULL );
#endif
