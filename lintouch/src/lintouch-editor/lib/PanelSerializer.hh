// $Id: PanelSerializer.hh 1169 2005-12-12 15:22:15Z modesto $
//
//   FILE: PanelSerializer.hh --
...
#ifndef _PANELSERIALIZER_HH
#define _PANELSERIALIZER_HH
...
namespace lt {
    ...
    class PanelSerializer
    {
        public:
            ...
            /**
             * Serialize the panel to the configuration and return the
