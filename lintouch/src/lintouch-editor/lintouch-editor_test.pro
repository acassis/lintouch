# $Id: lintouch-editor_test.pro 1564 2006-04-07 13:33:15Z modesto $
#
#   FILE: lintouch-editor_test.pro --
...
SOURCES = \
		  ...
		  tests/check_bindings.cpp \
		  tests/check_bindingshelper.cpp \
		  tests/check_editor.cpp \
		  tests/check_main.cpp \
