...
LT_SERVER_PLUGIN_CREATE( apr_pool_t * pool )
{
    ...
    return lt_server_plugin_info_create(
            "Hynek Petrak <hynek@swac.cz>",            /* author */
            VERSION,                                /* version */
            TODAY,                                  /* date */
            "AllenBradley",                                /* shortdesc */
            "AllenBradley Lintouch Server Plugin",         /* longdesc */
            props,                                  /* default props */
...
LT_SERVER_PLUGIN_RUN( lt_server_plugin_t * plugin )
{
    ...
    while( lt_server_plugin_should_run( plugin ) ) {
        ...
        printf( "AllenBradley: running...\n" );
    }

    printf( "AllenBradley: exiting...\n" );
    return LT_SERVER_SUCCESS;
}
